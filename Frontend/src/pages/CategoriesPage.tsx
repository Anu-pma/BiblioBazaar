...
//           <BookOpen className="mx-auto h-12 w-12 text-blue-500" />
//           <h1 className="mt-4 text-4xl font-bold text-gray-900">Book Categories</h1>
//           <p className="mt-2 text-lg text-gray-600">Click to explore books by category</p>
//         </div>
...
//                 className="w-full text-left px-6 py-4 flex items-center justify-between font-semibold text-lg text-gray-900 hover:bg-gray-100"
//               >
...
//                       <button
//                         onClick={() => navigate(`/books/${book._id}`)}
//                         className="mt-1 text-sm text-white bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded"
//                       >
//                         View Details
//                       </button>
//                     </div>
